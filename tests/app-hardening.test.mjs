...
test("a crashed renderer reloads only the application surface and a clean exit does not", () => {
  ...
  assert.match(handler, /void reloadApplicationSurface\(window\)/);
  const reload = main.slice(main.indexOf("async function reloadApplicationSurface"), main.indexOf("async function loadApplication("));
